...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-05.png" alt="XXD Panel 139 Sample 5"></td>
    <td width="50%"><img src="./assets/examples/sample-06.png" alt="XXD Panel 139 Sample 6"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-07.png" alt="XXD Panel 139 Sample 7"></td>
    <td width="50%"><img src="./assets/examples/sample-08.png" alt="XXD Panel 139 Sample 8"></td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-09.png" alt="XXD Panel 139 additional top-bottom sample 1"></td>
    <td width="50%"><img src="./assets/examples/sample-10.png" alt="XXD Panel 139 additional top-bottom sample 2"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-11.png" alt="XXD Panel 139 additional top-bottom sample 3"></td>
    <td width="50%"><img src="./assets/examples/sample-12.png" alt="XXD Panel 139 additional top-bottom sample 4"></td>
  </tr>
</table>
...
```bash
git clone https://github.com/nevertoday/xxd-panel-139.git
npx skills add https://github.com/nevertoday/xxd-panel-139 --skill xxd-panel-139
```

설치 후 Agent 세션을 다시 시작하고 `$xxd-panel-139`을 호출하세요. 사용자 단위 Codex 설치에는 `--global --agent codex --yes`를 추가할 수 있습니다.

```text
/xxd-panel-139 photo.jpg --mode top-bottom --size 3:4 --text prompt --locale ko-KR
/xxd-panel-139 photo.jpg --mode left-right --size 16:9 --text prompt --locale en-US
/xxd-panel-139 photo.jpg --mode design-only --size 9:16 --text none
```

전체 실행 계약은 [SKILL.md](SKILL.md), 런타임 어댑터는 [영어](references/xxd-panel-139-prompt.en.md)와 [중국어](references/xxd-panel-139-prompt.zh-CN.md)를 확인하세요.
...
- `design-only`: 전체 캔버스에 Panel 139의 디자인 번역만 표시하고 사진은 보이지 않는 참고 자료로 사용합니다.
